...
enum PWEventType
{
    ...
    PW_EVENT_MOUSE_MOVE,
    PW_EVENT_MOUSE_WHEEL,
    PW_EVENT_MOUSE_TOUCHPAD_BEGIN, // NOTE: touchpad not yet implemented on Windows
    PW_EVENT_MOUSE_TOUCHPAD_MOVE,
    PW_EVENT_MOUSE_TOUCHPAD_END,
    ...
    // Deprecated
    PW_EVENT_MOUSE_SCROLL_WHEEL = PW_EVENT_MOUSE_WHEEL,
};
